...
def make_registration(db_manager=None):
    ...
    esp32_cam01_signal = Sensor('1.3.6.1.3.999.1.14.3.1', 'ESP32 Cam01 RSSI', LocalOutliersFactorClassifier, db_manager)
    ...
    esp32_cam01_signal.train(['Seconds', 'Value'], {'Seconds': int, 'Value': float})
    ...
    # door_c305 = Sensor('1.3.6.1.3.999.1.15.3.1', 'Door C305', IsolationForestClassifier, db_manager, 'magnetic')
    # door_c306 = Sensor('1.3.6.1.3.999.1.15.3.2', 'Door C306', IsolationForestClassifier, db_manager, 'magnetic')
    # door_c307 = Sensor('1.3.6.1.3.999.1.15.3.3', 'Door C307', IsolationForestClassifier, db_manager, 'magnetic')
    # door_c308 = Sensor('1.3.6.1.3.999.1.15.3.4', 'Door C308', IsolationForestClassifier, db_manager, 'magnetic')
    #
    ...
    # window_c306 = Sensor('1.3.6.1.3.999.1.15.3.6', 'Window C306', IsolationForestClassifier, db_manager, 'magnetic')
    # window_c307 = Sensor('1.3.6.1.3.999.1.15.3.7', 'Window C307', IsolationForestClassifier, db_manager, 'magnetic')
    # window_c308_left = Sensor('1.3.6.1.3.999.1.15.3.5', 'Window C308 left', IsolationForestClassifier, db_manager, 'magnetic')
    #
    ...
    # door_c305_battery = Sensor('1.3.6.1.3.999.1.17.3.1', 'Battery door C306', LinearRegressionClassifier, db_manager)
    ...
    # motion_c306_right = Sensor('1.3.6.1.3.999.1.16.3.1', 'Motion C306 right', IsolationForestClassifier, db_manager, 'motion')
    # motion_c306_left = Sensor('1.3.6.1.3.999.1.16.3.2', 'Motion C306 left', IsolationForestClassifier, db_manager, 'motion')
    # motion_c307 = Sensor('1.3.6.1.3.999.1.16.3.3', 'Motion C307', IsolationForestClassifier, db_manager, 'motion')
    # motion_c308_left = Sensor('1.3.6.1.3.999.1.16.3.4', 'Motion C308 left', IsolationForestClassifier, db_manager, 'motion')
    # motion_c308_right = Sensor('1.3.6.1.3.999.1.16.3.5', 'Motion C308 right', IsolationForestClassifier, db_manager, 'motion')
    #
    ...
    # shp6_fridge_today = Sensor('1.3.6.1.3.999.1.7.3.9', 'SHP6 fridge today', PolynomialRegressionClassifier, db_manager)
...
if __name__ == '__main__':
    ...
    # sensor_manager = make_registration(None)

    # sensors = sensor_manager.get_sensors()

    print('Learning completed!')

    esp32_cam01_signal = Sensor('1.3.6.1.3.999.1.14.3.1', '', LocalOutliersFactorClassifier, None, 'magnetic')
    esp32_cam01_signal.train(['Value'], {'Value': float})
    state = esp32_cam01_signal.get_sensor_state(-80)
    ...
    #         timestamp = message_parser.get_timestamp()
    #         seconds = message_parser.get_seconds()
    #         day = message_parser.get_day()
    #
    #         state = esp32_cam01_signal.get_sensor_state(message_parser.get_value())
